...
namespace HoppingerPeople
{
  ...
  static public class QueryableExtensions {
    static public Page<T> Paginate<T, U>(this IQueryable<Tuple<U, bool>> self, bool can_create, bool can_delete, bool can_link, int page_index, int page_size, Func<U,U> g, Func<U,T> f, string search_query = null) where U : IEntity {
